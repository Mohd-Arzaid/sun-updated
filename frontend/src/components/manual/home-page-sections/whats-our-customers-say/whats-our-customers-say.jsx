          ...
          <div className="testimonials-marquee-track flex flex-nowrap items-center gap-6">
            {duplicated.map((testimonial, i) => (
              <div
                ...
                className="relative w-[350px] max-w-full shrink-0 rounded-2xl border border-neutral-200 bg-[linear-gradient(180deg,#fafafa,#f5f5f5)] px-8 py-6 md:w-[450px] h-[280px] md:h-[320px]"
              >
                <p className="text-base md:text-lg font-geist text-neutral-600 mb-6 leading-relaxed">
                  {testimonial.content}
                </p>

                <div className="flex flex-col gap-1 pt-6 border-t border-neutral-200">
