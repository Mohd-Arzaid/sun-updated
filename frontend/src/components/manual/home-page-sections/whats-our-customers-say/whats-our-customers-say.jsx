          ...
          <div className="testimonials-marquee-track flex-nowrap items-center gap-6">
            {duplicated.map((testimonial, i) => (
              <div
                ...
                className="relative w-[350px] max-w-full shrink-0 rounded-2xl border border-neutral-200 bg-[linear-gradient(180deg,#fafafa,#f5f5f5)] px-6 py-4 md:px-8 md:py-6 md:w-[450px] h-[280px] md:h-[320px]"
              >
